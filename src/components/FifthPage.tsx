...
// ṛesponsive for the tablet view in ipad mini 
  return (
    <div className='w-full h-[160vh] md:h-[73vh] zs:h-[175vh] xs:h-[135vh] bg-[#1EC5FC] overflow-hidden px-1 pt-10 '>
      ...
      {/* this is the text area  */}
       ...
       <div className=' md:block hidden  text-[6.54rem] leading-[5rem]  px-[3px] tracking-tight  f1 uppercase'>
                              <p className=' overflow-hidden pl-[20%]'>We're Providing</p>
                              <p >full-services</p>
               </div>
      {/* this is the blue area paragraph area  */}
               <div className='w-full gap-10 md:gap-0 md:justify-between  mt-6 md:px-2 my-10 f2 text-[22.5px] zs:text-[23px] xs:text-[24px] ss:text-[25.5px] zm:text-[27px] md:text-[15.5px] md:leading-[17.5px] tracking-tight leading-[25px] zs:leading-[26px] xs:leading-[27.5px] ss:leading-[28.5px] zm:leading-[30px] flex flex-col md:flex-row items-center justify-center   '>

                          <div className='text-center zs:opacity-80 xs:opacity-90 zm:opacity-100' >
                                  <p>Positioning</p>
                                  <p>Storytelling</p>
                                  <p>Brand Strategy</p>
                                  <p>Brand identity</p>
               ...
               <div className='text-[4.6rem] md:text-[6.4rem] md:leading-[5rem] zs:text-[4.79rem] xs:text-[5rem] ss:text-[5.35rem] px-[3px] tracking-tight leading-[3.5rem] zs:leading-[3.6rem] xs:leading-[3.8rem] ss:leading-[4.08rem] f1 uppercase'>
