...
// ipad mini screen size done somewhat complete  
  ...
  return (
    <div className=' w-full relative z-[5000000]  h-[87.5vh] zs:h-[108vh] xs:h-[86.5vh]  overflow-hidden pt-[110px] md:pt-[80px] md:h-[53vh] zs:pt-[117px] ss:pt-[128px] px-[5px]'>
               ...
               <div className=' w-[46%] md:w-[36%] md:h-[45%] z-[50000] md:left-[100px] p-[2px] top-[3%] h-[25%]   zs:h-[27%] xs:h-[24%] ss:h-[25%] relative overflow-hidden skew-y-[8deg] md:skew-y-[12deg] '>
