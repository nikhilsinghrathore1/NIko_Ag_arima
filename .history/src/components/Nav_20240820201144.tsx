...
const Nav = () => {
  return (
    <div className='w-full h-[10%] flex items-center justify-between fixed pl-[14px] pr-[15.5px] py-1'>
               ...
               <div className='w-[18%] h-[55%] font-light uppercase f3 tracking-tight font-extrabold text-[20px] border-black border-[1px] rounded-sm flex items-center justify-center'>
                              <h1 className='leading-none'>Menu</h1>
               </div>
    </div>
  )
}
