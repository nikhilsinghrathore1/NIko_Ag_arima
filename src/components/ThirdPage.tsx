  ...
  return (
    <div className='w-full h-[90vh] zs:h-[110vh] xs:h-[93vh] pt-12 overflow-hidden'>
      ...
      {/* this is the top heading text  */}
               ...
               <div className='text-[4.6rem] zs:text-[4.79rem] xs:text-[5.1rem] ss:text-[5.3rem] px-[6px] relative skew-x-0 z-[114] tracking-tight leading-[3.5rem] zs:leading-[3.6rem] xs:leading-[3.8rem] ss:leading-[3.9rem] f1 uppercase'>
                              <h1> the balance</h1>
                              <h1 className='pl-16'> between</h1>
               </div>
               
               <div className=' w-[96%] px-[3px] -mt-14 zs:-mt-12 xs:-mt-[3rem] ss:-mt-[3.3rem] box3 h-[37%] top-[5px] bg-zinc-100  relative   mx-auto '>
               ...
               <div className='text-[4.5rem] zs:text-[4.79rem] xs:text-[5rem] px-[6px] relative skew-x-0 z-[114] tracking-tight leading-[3.4rem] zs:leading-[3.6rem] xs:leading-[3.8rem] f1 uppercase'>
               ...
               <div className='f2 w-full text-[22.5px] zs:text-[23.5px] xs:text-[25px] ss:text-[25.5px] z-[200] tracking-tight text-center mt-5 xs:mt-8 relative opacity-85 xs:opacity-100 leading-[24px] zs:leading-[25.5px] xs:leading-[28px] ss:leading-[29px]'>
