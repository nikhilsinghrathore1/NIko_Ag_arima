  ...
  return (
    <div className='w-full h-[160vh] zs:h-[175vh] xs:h-[135vh] bg-[#1EC5FC] overflow-hidden px-1 pt-10 '>
      {/* this is the first blue area huge text */}
       <div className='text-[4.6rem] zs:text-[4.79rem] xs:text-[5rem] ss:text-[5.45rem] zm:text-[5.5rem] px-[3px] tracking-tight leading-[3.5rem] zs:leading-[3.6rem] xs:leading-[3.8rem] ss:leading-[4.08rem] zm:leading-[4.25rem] f1 uppercase'>
      ...
      {/* this is the blue area paragraph area  */}
               <div className='w-full gap-10 my-10 f2 text-[22.5px] zs:text-[23px] xs:text-[24px] ss:text-[25.5px] zm:text-[27px] tracking-tight leading-[25px] zs:leading-[26px] xs:leading-[27.5px] ss:leading-[28.5px] zm:leading-[30px] flex flex-col items-center justify-center   '>
