  ...
  return (
    <div className=' w-full h-screen pt-[117px] px-2'>
               ...
               <div className=' w-full h-full   border-[1px] border-black overflow-hidden'>
                              <img className='w-full h-full object-cover scale-120 object-top' src="https://images.prismic.io/localstudio/65ae835438f662e9dd21247c_matthieu-solo-hd.png?auto=format,compress" alt="not showing" />
               </div>
               </div>
    </div> 
  )
