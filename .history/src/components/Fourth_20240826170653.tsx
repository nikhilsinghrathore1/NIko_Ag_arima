  ...
  return (
    <div className='w-full h-[65vh] overflow-hidden -mt-2'>
      {/* this is the div that contains the inner images */}
               <div className='relative flex items-start justify-center w-full box4 h-[70%] bg-red-300 pt-8 bg overflow-   '>
    ...
    <div className=' w-full h-[30%] bg-black flex items-center justify-center'>
