  ...
  return (
    <div className=' w-full h-screen pt-[117px] px-[5px]'>
               ...
               {/* this is the second inner div that contains the images */}
                              ...
                              <div className='w-full border-[1px] border-black overflow-hidden h-full'>
                                             <img src="https://images.prismic.io/localstudio/65ae837038f662e9dd21247e_thibaud-solo-hd.png?auto=format,compres" alt="not showing " />
                              </div>
