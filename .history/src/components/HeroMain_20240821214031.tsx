...
const HeroMain = () => {
  return (
    <div className=' w-full h-screen pt-[117px] px-[3px]'>
               {/* container for the main big text */}
               <div className='text-[4.79rem] px-[1px] tracking-tight leading-[3.6rem] f1 uppercase'>
               ...
               <div className='bo w-[45%] float- p-[2px] top-[3%]   h-[27%] relative overflow-hidden skew-y-6 '>
