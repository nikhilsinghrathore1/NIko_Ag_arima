...
// s20 ultra
  ...
  return (
    ...
    <div className='w-full h-[40%] zs:h-[35%] ss:h-[38%] flex items-center justify-center'>
                    <div className='px-[15px] zs:px-[6px] xs:px-[8px] ss:px-[15px] rounded uppercase zs:py-[2px] xs:py-[1px] ss:py-0 f1 text-[1.7rem] zs:text-[2rem] xs:text-[2.1rem] rotate-6 mt-5 xs:mt-12 border-[2px] border-black/50'>
                        credit
                    </div>
    </div>
