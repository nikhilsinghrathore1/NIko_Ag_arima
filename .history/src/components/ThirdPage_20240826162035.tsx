  ...
  return (
    <div className='w-full h-[100vh] pt-10'>
      {/* this is the top heading text  */}
               ...
               <div className=' w-[96%] px-[3px] -mt-10 box3 h-[35%] z-[200] bg-blue-50 overflow-hidden  relative   mx-auto '>
                        <div className='w-full h-full overflow-hidden skew  relative   border-x-[1px] border-b-[1px] border-black '>
                                <img className='w-full h-full object-cover translate-y-[50px] object-top scale-125 relative z-[117]' src="https://images.prismic.io/localstudio/65ae849838f662e9dd2124a4_full.png?auto=format,compress" alt="not showing" />
                        </div>
               </div>
